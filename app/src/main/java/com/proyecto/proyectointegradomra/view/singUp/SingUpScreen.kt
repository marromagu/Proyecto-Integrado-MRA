...
@Composable
fun SingUpScreen(
    viewModel: SingUpViewModel = SingUpViewModel()
) {
    Column(
        modifier = Modifier
            .fillMaxSize()
...
@Composable
fun Registrador(modifier: Modifier, viewModel: SingUpViewModel) {
    ...
    Column(modifier = modifier) {
        ...
        CampoDeTexto(correo, "Correo electrónico", customTextField, email){viewModel.updateCorreo(it)}
